...
import com.aswifter.material.duagram.VoronoiRegion.VoronoiPoint;
...
public class VoronoiView extends ViewGroup {
    ...
    private void init(AttributeSet attrs) {
        ...
        mBorderColor = a.getColor(R.styleable.VoronoiView_vorborder_color, DEF_BORDERS_COLOR);
        mBorderWidth = a.getFloat(R.styleable.VoronoiView_vorborder_width, DEF_BORDER_WIDTH);
        mRoundCornersEnabled = a.getBoolean(R.styleable.VoronoiView_vorborder_round, DEF_BORDER_CORNERS_ROUND);
